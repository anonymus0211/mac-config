...
if [[ ":$FPATH:" != *":/Users/daniel.rozsa/.zsh/completions:"* ]]; then export FPATH="/Users/daniel.rozsa/.zsh/completions:$FPATH"; fi
...
plugins=(git node npm macos encode64 extract last-working-dir jira docker aws kubectl zsh-ssh)
...
export PATH="$PATH:/Users/daniel.rozsa/.nsccli/bin"
